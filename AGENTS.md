...
- **Package manager: pnpm** (workspace root scripts use pnpm).
...
- Build issues: if `main.js` is missing, run `pnpm run build` or `pnpm run dev --filter plugin` to compile your TypeScript source code.
